-- Let members clean duplicate-marked returned/draft records without losing audit history.
...
begin
  ...
  if p_action in ('return','reject','review','pending','archive','trash','close_duplicate','dispute','restore') then
